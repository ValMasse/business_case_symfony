 ...
 */
final class Version20200830140524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, date_naissance DATETIME NOT NULL, numero_pe VARCHAR(10) DEFAULT NULL, telephone VARCHAR(10) NOT NULL, mail VARCHAR(50) NOT NULL, cv VARCHAR(255) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE candidat_reponse_possible (candidat_id INT NOT NULL, reponse_possible_id INT NOT NULL, INDEX IDX_FD63200E8D0EB82 (candidat_id), INDEX IDX_FD63200EC53BC6BC (reponse_possible_id), PRIMARY KEY(candidat_id, reponse_possible_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE candidat_info_co (candidat_id INT NOT NULL, info_co_id INT NOT NULL, INDEX IDX_69BB06108D0EB82 (candidat_id), INDEX IDX_69BB0610E8ACC402 (info_co_id), PRIMARY KEY(candidat_id, info_co_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE candidat_reponse_possible ADD CONSTRAINT FK_FD63200E8D0EB82 FOREIGN KEY (candidat_id) REFERENCES candidat (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE candidat_reponse_possible ADD CONSTRAINT FK_FD63200EC53BC6BC FOREIGN KEY (reponse_possible_id) REFERENCES reponse_possible (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE candidat_info_co ADD CONSTRAINT FK_69BB06108D0EB82 FOREIGN KEY (candidat_id) REFERENCES candidat (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE candidat_info_co ADD CONSTRAINT FK_69BB0610E8ACC402 FOREIGN KEY (info_co_id) REFERENCES info_co (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE candidat_reponse_possible DROP FOREIGN KEY FK_FD63200E8D0EB82');
        $this->addSql('ALTER TABLE candidat_info_co DROP FOREIGN KEY FK_69BB06108D0EB82');
        $this->addSql('ALTER TABLE question DROP FOREIGN KEY FK_B6F7494E4272FC9F');
        $this->addSql('ALTER TABLE session DROP FOREIGN KEY FK_D044D5D45200282E');
        $this->addSql('ALTER TABLE candidat_info_co DROP FOREIGN KEY FK_69BB0610E8ACC402');
        ...
        $this->addSql('ALTER TABLE candidat_reponse_possible DROP FOREIGN KEY FK_FD63200EC53BC6BC');
        ...
        $this->addSql('DROP TABLE candidat_reponse_possible');
        $this->addSql('DROP TABLE candidat_info_co');
