...
class Administrateur implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=TestTechnique::class, mappedBy="administrateur")
     */
    private $testsTechniques;

    /**
     * @ORM\ManyToMany(targetEntity=Question::class, inversedBy="administrateurs")
     */
    private $questions;
    ...
    public function addTestsTechnique(TestTechnique $testsTechnique): self
    {
        if (!$this->testsTechniques->contains($testsTechnique)) {
            ...
            $testsTechnique->setAdministrateur($this);
        }
    ...
    public function removeTestsTechnique(TestTechnique $testsTechnique): self
    {
        if ($this->testsTechniques->contains($testsTechnique)) {
            ...
            if ($testsTechnique->getAdministrateur() === $this) {
                $testsTechnique->setAdministrateur(null);
            }
        }
